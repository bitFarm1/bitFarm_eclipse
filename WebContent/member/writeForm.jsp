...
<div> 
	<table cellpadding="10px">  
		<tr> 
			...
			<td><input class="layoutT" type="text" name="user_id" placeholder="6자 이상의 영문 혹은 영문과 숫자를 조합"></td>
		...
		<tr>
			...
			<td><input class="layoutT" type="text" name="user_name" placeholder="고객님의 이름을 입력해주세요"></td>
			<td></td>
		</tr>
		<tr>
			<th class="subject">이메일*</th>
			<td><input class="layoutT" type="text" name="user_email" placeholder="예: bitfarm@bitfarm.com"></td>
			<td><input class="layoutB" type="button" name="checkEmail" value="이메일 중복확인"></td>
		</tr>
		<tr>
			<th class="subject">휴대폰*</th>
			<td><input class="layoutT" type="text" name="user_phone" placeholder="숫자만 입력해주세요"></td>
			<td></td>
		</tr>
		<tr>
		...
		<tr> 
			...
			<td><input type="radio" name="user_gender" value="m">남자
			<input type="radio" name="user_gender" value="w">여자
			<input type="radio" name="user_gender" value="n">선택안함
			</td>
			<td></td>
		</tr>
		<tr>
